...
enum ElementType {
  heading, paragraph, button, list, video, card, icon, imageSlider, submitButton, nextButton, backButton, loginButton, image, logo, radioGroup, checkbox, bottomBar, cardRow2, cardRow3, appBar, inputField, uploadFile
}
...
final Map<String, dynamic> pageData = {
  ...
  'elements': [
    ...
    },
    {
      ...
      'textWrapping': false,
      'imageInsideContent': false,
      'imageUrl': 'https://picsum.photos/id/640/120/60',
      'fit': 'contain',
    },
  ]
};
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Save element data to user_edit_screen collection
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'userId': null, // We don't have user authentication in the generated app
        }),
      ).timeout(const Duration(seconds: 30));
          ...
          children: [
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1758141859510'],
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1758141862620'],
                  decoration: InputDecoration(
                    labelText: 'password',
                    hintText: 'Enter text',
                    border: OutlineInputBorder(),
...
,
            ...
            child: Container(
              ...
              child: Opacity(
                ...
                child: ClipOval(
                  child: Image.network(
                    'https://picsum.photos/id/640/120/60',
                    fit: BoxFit.cover,
                    width: 100.83335876464847,
                    height: 93.33335876464844,
                  ),
