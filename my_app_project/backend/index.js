...
// Save element data to user_element_screen collection in element database
app.post('/save-element-data', async (req, res) => {
  ...
  try {
    ...
    // Generate unique element_id for each element
    ...
    // Save to MongoDB in "user_element_screen" collection in element database
...
// Upload image and save to user_element_screen collection in element database
...
// Save element data to user_edit_screen collection in element database
...
// Upload image and save to user_edit_screen collection in element database
